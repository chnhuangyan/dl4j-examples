package org.deeplearning4j.examples.recurrent.stockPred;
...
/**
 * Created by YoungH on 10/20/16.
 */
public class StockPredExamples {
...
//        String inputFile = StockRnnPredict.class.getClassLoader().getResource("stock/sh000001.csv").getPath();
        ...
        String inputFile = "dl4j-examples/src/main/resources/stock/sh000001.csv";
        int batchSize = 1;
